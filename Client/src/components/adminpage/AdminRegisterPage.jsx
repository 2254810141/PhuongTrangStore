      ...
      <div className="w-full max-w-md rounded-3xl border border-zinc-200 bg-white p-8 shadow-xl">
        ...
        <form className="mt-6 space-y-4" onSubmit={handleSubmit(onSubmit)}>
          <div>
            ...
            />
            {errors.fullName && <p className="mt-1 text-xs text-amber-600">{errors.fullName.message}</p>}
          </div>
          ...
          <div>
            ...
            />
            {errors.adminRegistrationCode && <p className="mt-1 text-xs text-amber-600">{errors.adminRegistrationCode.message}</p>}
          </div>
        ...
        <div className="mt-6 flex items-center justify-between gap-3 text-sm text-zinc-600">
          ...
          <Link to="/admin/login" className="font-semibold text-amber-600 hover:underline">
            Đăng nhập
          </Link>
        </div>
      </div>
